...
object ScPrefs {
    ...
    val SWIPE_TO_REPLY = ScStringListPref(
        "SWIPE_TO_REPLY",
        SwipeToReplyMode.LEFT,
        arrayOf(SwipeToReplyMode.LEFT, SwipeToReplyMode.OFF),
        R.array.sc_swipe_to_reply_names,
        null,
        R.string.sc_pref_swipe_to_reply_title,
        R.string.sc_pref_swipe_to_reply_summary,
    )
